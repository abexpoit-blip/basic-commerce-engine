    ...
    return (
      <div className="p-16 text-center rounded-3xl bg-white border border-slate-200 shadow-sm">
        ...
        <p className="text-xs text-slate-500 max-w-md mx-auto mb-6 leading-relaxed">
          Create your first shielded campaign link to protect your Facebook ads against policy crawlers while forwarding real buyer clicks to your destination page.
        </p>
        <button
      ...
      {qrSlug && (
        ...
        >
          ...
          >
            ...
            <p className="text-xs text-slate-500 mb-4 font-mono">/r/{qrSlug}</p>
